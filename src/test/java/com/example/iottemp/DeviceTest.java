...
import com.example.iottemp.hierarchy.Device;
import com.example.iottemp.hierarchy.DeviceGroup;
import com.example.iottemp.hierarchy.DeviceManager;
...
public class DeviceTest {
  ...
  public void testReplyToRegistrationRequests() {
    TestProbe<DeviceManager.DeviceRegistered> probe =
  ...
  public void testIgnoreWrongRegistrationRequests() {
    ...
    ActorRef<DeviceGroup.Command> groupActor = testKit.spawn(DeviceGroup.create("group"));
    groupActor.tell(
            new DeviceManager.RequestTrackDevice("wrongGroup", "device1", probe.getRef()));
  ...
  public void testListActiveDevices() {
    ...
    groupActor.tell(
            new DeviceManager.RequestTrackDevice(
    ...
    groupActor.tell(
            new DeviceManager.RequestDeviceList(
            0L, "group", deviceListProbe.getRef()));
  ...
  public void testListActiveDevicesAfterOneShutsDown() {
    ...
    groupActor.tell(
            new DeviceManager.RequestDeviceList(0L, "group", deviceListProbe.getRef()));
    DeviceManager.ReplyDeviceList reply = deviceListProbe.receiveMessage();
    assertEquals(0L, reply.requestId);
    assertEquals(Stream.of("device1", "device2").collect(Collectors.toSet()), reply.ids);
    ...
    registeredProbe.awaitAssert(
            () -> {
              groupActor.tell(
                      new DeviceManager.RequestDeviceList(
                              1L, "group", deviceListProbe.getRef()));
