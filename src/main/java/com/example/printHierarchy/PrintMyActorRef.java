...
public class PrintMyActorRef extends AbstractBehavior<String> {

  static Behavior<String> create() {
    return Behaviors.setup(PrintMyActorRef::new);
  }

  private PrintMyActorRef(ActorContext<String> context) {
    super(context);
  }
